...
import droneFootageVideo from '../assets/dronefootage1.mp4'
    ...
    <div className="analyze-page">
      ...
      <div className="video-background">
        <video 
          ...
          className="bg-video"
        >
          <source src={droneFootageVideo} type="video/mp4" />
      ...
      <div className="analyze-container">
        ...
        <div className="header-section">
          ...
          <p className="header-description">
            Upload your Drone footage to receive AI-powered analysis of damage severity, 
            critical response needs, and potential hazards.
          </p>
        </div>
